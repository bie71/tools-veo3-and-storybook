...
ARG VITE_VIDEO_QUEUE_DELAY_MS=5000
ARG VITE_IMAGE_QUEUE_DELAY_MS=4000
ARG VITE_STORY_QUEUE_DELAY_MS=5000
ENV VITE_GA_MEASUREMENT_ID=${VITE_GA_MEASUREMENT_ID}
ENV VITE_SHOW_DEVTOOLS=${VITE_SHOW_DEVTOOLS}
ENV VITE_VIDEO_QUEUE_DELAY_MS=${VITE_VIDEO_QUEUE_DELAY_MS}
ENV VITE_IMAGE_QUEUE_DELAY_MS=${VITE_IMAGE_QUEUE_DELAY_MS}
ENV VITE_STORY_QUEUE_DELAY_MS=${VITE_STORY_QUEUE_DELAY_MS}
